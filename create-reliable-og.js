// Create a reliable OG image using a different approach
const fs = require('fs');
const https = require('https');

// Create a simple but professional SVG
...
// Save SVG file
fs.writeFileSync('onpurpose-og-final.svg', svgContent);
...
fs.writeFileSync('onpurpose-og-final-uri.txt', dataUri);

// Test if we can use a different service - let's try GitHub raw content
console.log('🌐 Creating a GitHub-compatible solution...');

// Update the website with the data URI
console.log('✅ Ready to update website with reliable OG image');
