...
function Home() {
  ...
  // Force consistent homepage render on every navigation
  useEffect(() => {
    window.scrollTo(0, 0);

    // Force full re-render to prevent stale UI
  ...
  return (
    <div className="App">
      ...
      <div className="container">
        ...
        <div className="ai-generator" id="ideaGenerator">
          ...
          <div className="ai-content">
            ...
            <div className="idea-generator">
              ...
              {showResults && (
                <div className="ideas-result" id="ideasResult">
