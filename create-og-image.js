// Create a proper OG image for OnPurpose brand
const https = require('https');
const fs = require('fs');

// Create a simple SVG-based OG image that will work everywhere
const svgContent = `
<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="600" y="320" font-family="Arial, sans-serif" font-size="48" font-weight="bold" text-anchor="middle" fill="url(#text)" filter="url(#glow)">
    Idea → Service → Income
  </text>
...
console.log('📁 File: og-image.svg');
console.log('🎨 Dark background with electric blue gradient text');
console.log('📏 Size: 1200x630');
console.log('🌐 Ready for Facebook and all social media platforms');
