-- OnPurpose Database Setup - Execute in psql
-- Run these commands one by one in your psql session

-- Create HostApplications table
...
('Jennifer', 'Kim', 'jennifer.network@email.com', 'Professional Networker', 'Tech startup founder and angel investor connecting ambitious professionals', 'Navigate NYC startup ecosystem and build meaningful professional relationships that matter', 'Manhattan', 75.00, '10-15 hours', 'approved');
